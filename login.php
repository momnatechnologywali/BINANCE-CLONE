...
if ($_POST) {
    ...
    if ($user && verifyPassword($password, $user['password'])) {
        ...
        echo "<script>setTimeout(() => redirect('dashboard.php'), 2000);</script>";
    } else {
...
<head>
    ...
    <style>
        /* Same awesome dark theme as signup */
...
<body>
    <div class="form-container">
        ...
        <div class="back-link"><a href="#" onclick="redirect('index.php')">Back to Home</a> | <a href="#" onclick="redirect('signup.php')">Sign Up</a></div>
    </div>
    <script>
